export default class Rocket extends Phaser.GameObjects.Graphics {
  ...
  constructor(scene: Phaser.Scene, conf: { forceX: number, forceY: number, padding: number }) {
    super(scene)
...
_setText(text: string) {
  ...
  const y = (this.forceY || (this.getGameHeight() - this.windowHeight - this.padding)) + 10;
