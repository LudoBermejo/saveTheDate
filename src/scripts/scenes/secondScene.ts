...
export default class SecondScene extends Phaser.Scene {
  ...
  createRockets() {
    setTimeout(()=> {
      const rocket = new Rocket(this, this.cameras.main.width / 2, this.cameras.main.height)
      this.createRockets();
  ...
  create() {
    this.ludoSprite = new LudoSprite(this, this.cameras.main.width, this.cameras.main.height - 100);
    ...
    this.ludoSprite.on('COMPLETE', () => {
      ...
      this.dialogLudo.setText(
        [
          ...
          { text: 'You know... all the effort, the deadlines, the event calendar...' },
            ...
            this.ludoSprite.on('COMPLETE_EXIT', () => {
              ...
              this.dialogMara.on('COMPLETE_LINE', (line) => {
                if (line === 4) {
                  ...
                  this.dialogMara.destroy();
                  this.maraSprite = new MaraSprite(this, this.cameras.main.width, this.cameras.main.height - 100);
                  ...
                  this.maraSprite.on('COMPLETE', () => {
                    ...
                    this.dialogFinal.setText(
                      [
                        ...
                        { text: 'Oh boy...' },
                        { text: 'I... er... want... err' },
                        { text: 'I WILL SHARE WITH YOU THE ADDRESS WHEN I HAVE ONE!!!!!!!' },
                        { text: 'BYE!', wait: 3000 },
                        { text: '' },
                      ]
                    )
